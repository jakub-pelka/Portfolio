...
<CompareBlock beforeLabel="STANDARDOWE PODEJŚCIE" afterLabel="PRACO">
  <CompareRow label="Dane osobowe" before="Trafiają do AI razem z treścią" after="Zostają lokalnie — AI ich nigdy nie widzi" />
  <CompareRow label="Baza danych" before="Zewnętrzny serwer / chmura" after="SQLite na urządzeniu użytkownika" />
  <CompareRow label="CV z imieniem" before="Generowane przez API" after="Sklejane po stronie frontendu, po generowaniu" />
  <CompareRow label="Dane wrażliwe w czacie" before="Użytkownik wysyła dane osobowe bezpośrednio do modelu" after="Anonimizowane przed wysłaniem — AI ich nigdy nie widzi" />
</CompareBlock>
