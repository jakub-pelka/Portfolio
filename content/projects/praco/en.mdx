...
<FullwidthImage
  ...
  alt="AI interview pipeline diagram"
  caption="INTERVIEW PIPELINE — how AI conducts the conversation and extracts data into the user profile"
  frame={false}
/>

<FullwidthImage
  src="/projects/praco/cv_generation_pipeline.png"
  alt="CV generation pipeline diagram"
  caption="CV GENERATION PIPELINE — personal data anonymised before sending to the model, assembled client-side after generation"
  frame={false}
/>
